...
token = "950cafb176bf9c2b7eeff0aff64860be"
iCIDADE = "São Paulo"
...
if iTIPOCONSULTA == 1:
    iURL = f"http://apiadvisor.climatempo.com.br/api/v1/locale/city?name=São Paulo&state=SP&token={token}"
    iRESPONSE = requests.request("GET", iURL)
    iRETORNO_REQ = json.loads(iRESPONSE.text)
    #print(iRETORNO_REQ)

    for iCHAVE in iRETORNO_REQ:
        print(f'{iCHAVE}  :  {str(iRETORNO_REQ[iCHAVE])}')
...
if iTIPOCONSULTA == 2:
    iURL = "http://apiadvisor.climatempo.com.br/api/v1/anl/synoptic/locale/BR?token=" + token
    iRESPONSE = requests.request("GET", iURL)
    iRETORNO_REQ = json.loads(iRESPONSE.text)
    #print(iRETORNO_REQ)
...
if iTIPOCONSULTA == 3:
    iURL = "http://apiadvisor.climatempo.com.br/api/v1/forecast/locale/" + iCIDADE + "/days/15?token=" + token
    iRESPONSE = requests.request("GET", iURL)
    iRETORNO_REQ = json.loads(iRESPONSE.text)
    #print(iRETORNO_REQ)
...
if iTIPOCONSULTA == 4:
    iURL = "http://apiadvisor.climatempo.com.br/api/v1/forecast/region/centro-oeste?token=" + token
    iRESPONSE = requests.request("GET", iURL)
    iRETORNO_REQ = json.loads(iRESPONSE.text)
    #print(iRETORNO_REQ)
...
if iTIPOCONSULTA == 5:
    iURL = "http://apiadvisor.climatempo.com.br/api/v1/forecast/locale/" + iCIDADE + "/hours/72?token=" + token
    iRESPONSE = requests.request("GET", iURL)
    iRETORNO_REQ = json.loads(iRESPONSE.text)
    #print(iRETORNO_REQ)
...
if iTIPOCONSULTA == 6:
    ...
    iURL = "http://apiadvisor.climatempo.com.br/api/v1/locale/city?name=" + iCITY + "&token=" + token
    iRESPONSE = requests.request("GET", iURL)
    iRETORNO_REQ = json.loads(iRESPONSE.text)
    #print(iRETORNO_REQ)
...
if iTIPOCONSULTA == 8:
    iURL = "http://apiadvisor.climatempo.com.br/api/v1/locale/city/" + iCIDADE + "?token=" + token
    iRESPONSE = requests.request("GET", iURL)
    iRETORNO_REQ = json.loads(iRESPONSE.text)
    #print(iRETORNO_REQ)
